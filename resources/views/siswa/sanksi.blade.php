                                ...
                                <div class="flex items-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="text-sm text-gray-600 mb-2">
                                            ...
                                            @if($siswa->poin_pelanggaran >= 1 && $siswa->poin_pelanggaran <= 5)
                                                <span class="text-yellow-600">Teguran Lisan / Peringatan Tertulis</span>
                                            @elseif($siswa->poin_pelanggaran >= 6 && $siswa->poin_pelanggaran <= 15)
                                                <span class="text-orange-600">Peringatan Tertulis + Panggilan Orang Tua / Skorsing 1-3 Hari</span>
                                            @elseif($siswa->poin_pelanggaran >= 16 && $siswa->poin_pelanggaran <= 90)
                                                <span class="text-red-600">Dikembalikan kepada Orang Tua + Pembinaan 1 Bulan</span>
                                            @elseif($siswa->poin_pelanggaran > 90)
                                                <span class="text-red-600">Dikeluarkan dari Sekolah</span>
                                            @endif
                                        </div>
