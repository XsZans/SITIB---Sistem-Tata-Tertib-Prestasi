...
<body class="gradient-bg">
    ...
    @include('layouts.kesiswaan-navbar', ['title' => 'Laporan Pelanggaran', 'subtitle' => 'Verifikasi Laporan Pelanggaran'])
    ...
    <div class="container mx-auto px-4 py-4 md:py-8 max-w-6xl">
        ...
        <main id="pelanggaran-section" class="glass-card rounded-2xl md:rounded-3xl shadow-xl p-4 md:p-8 mb-8" data-aos="fade-up">
            <div class="mb-6">
                ...
                <p class="text-gray-600">Pelanggaran yang menunggu persetujuan kesiswaan</p>
            </div>
        ...
        <main id="prestasi-section" class="glass-card rounded-2xl md:rounded-3xl shadow-xl p-4 md:p-8 mb-8" data-aos="fade-up">
            <div class="mb-6">
                ...
                <p class="text-gray-600">Prestasi yang menunggu persetujuan kesiswaan</p>
            </div>
    ...
    <div id="tolakModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full">
            ...
            <form id="tolakForm" method="POST" action="{{ route('kesiswaan.verifikasi-laporan') }}">
                @csrf
    ...
    <!-- Verification Form -->
    <form id="verifikasiForm" method="POST" action="{{ route('kesiswaan.verifikasi-laporan') }}" style="display: none;">
        @csrf
