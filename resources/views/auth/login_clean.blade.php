...
<head>
    ...
    <title>Login - SiTib SMK Bakti Nusantara 666</title>
            ...
            <div class="grid lg:grid-cols-2 gap-6 md:gap-8 items-center">
                ...
                <div class="glass-card rounded-2xl md:rounded-3xl shadow-xl p-6 md:p-8 card-hover" data-aos="fade-right">
                    ...
                    <div class="text-center mb-5 md:mb-6">
                        ...
                        <h1 class="text-xl md:text-2xl font-bold text-gray-800 mb-1">SiTib Login</h1>
                    ...
                    <form action="{{ route('custom.login.post') }}" method="POST" class="space-y-4 md:space-y-5">
                        ...
                        <!-- Role Selection -->
                        <div>
                            <label for="role" class="block text-xs md:text-sm font-semibold text-gray-700 mb-2">
                                <i class="fas fa-user-tag mr-2 text-blue-600"></i>Login Sebagai
                            </label>
                        ...
                        <!-- Login Button -->
                        <button type="submit"
                            class="w-full bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white py-2.5 md:py-3 px-6 rounded-xl text-sm md:text-base font-semibold transition-all duration-300 shadow-lg hover:shadow-xl">
                ...
                <div class="space-y-4 md:space-y-5" data-aos="fade-left">
                    ...
                    <div class="glass-card rounded-xl md:rounded-2xl p-4 md:p-6 shadow-xl card-hover border-l-4 border-blue-500">
                        <div class="flex items-start gap-3 md:gap-4">
                            ...
                            <div>
                                <h3 class="font-bold text-gray-800 mb-1.5 md:mb-2 text-base md:text-lg">SiTib - Sistem Tata Tertib</h3>
