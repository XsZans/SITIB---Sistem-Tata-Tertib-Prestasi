...
<head>
    ...
    <title>Data Pelanggaran Anak - SiTib</title>
...
<body class="gradient-bg">
    ...
    @include('layouts.orang-tua-navbar', ['title' => 'Data Pelanggaran Anak', 'subtitle' => 'Riwayat Pelanggaran Anak'])
    ...
    <div class="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div class="glass-card rounded-2xl shadow-xl p-6 mb-8" data-aos="fade-up">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Data Pelanggaran Anak</h1>
                    <p class="text-gray-600">Riwayat pelanggaran yang dilakukan anak</p>
                </div>
                <div class="text-right">
                    <div class="text-2xl font-bold text-red-600">{{ $pelanggaran->count() }}</div>
                    <div class="text-sm text-gray-600">Total Pelanggaran</div>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card rounded-2xl shadow-xl p-6 mb-8" data-aos="fade-up" data-aos-delay="100">
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('orang_tua.pelanggaran') }}" class="px-4 py-2 rounded-lg text-sm font-medium transition-colors {{ !request('status') ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }}">
                        <i class="fas fa-list mr-1"></i>Semua
                    </a>
                    <a href="{{ route('orang_tua.pelanggaran', ['status' => 'selesai']) }}" class="px-4 py-2 rounded-lg text-sm font-medium transition-colors {{ request('status') == 'selesai' ? 'bg-green-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }}">
        ...
        <div class="glass-card rounded-2xl shadow-xl overflow-hidden" data-aos="fade-up" data-aos-delay="200">
            <div class="p-6 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <h2 class="text-xl font-semibold text-gray-800">Daftar Pelanggaran</h2>
                    @if(request('status'))
            ...
            <div class="p-12 text-center">
                <div class="text-gray-500">
                    ...
                    <p class="text-xl font-medium mb-2">Tidak ada data pelanggaran</p>
                    <p class="text-sm">Selamat! Anak Anda belum memiliki catatan pelanggaran.</p>
                </div>
            </div>
            @endif
        </div>
