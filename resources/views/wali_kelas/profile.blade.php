...
<body class="gradient-bg">
    ...
    @include('layouts.wali-kelas-navbar', ['title' => 'Sistem Tata Tertib & Prestasi', 'subtitle' => 'Profile Wali Kelas', 'guru' => $guru])
    ...
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="glass-card rounded-2xl p-8 mb-8" data-aos="fade-up">
            <div class="text-center mb-8">
                ...
                <p class="text-purple-600 font-medium">Wali Kelas {{ $guru->wali_kelas }}</p>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-800">{{ $guru->wali_kelas ?? 'Tidak ada data' }}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-800">Wali Kelas</p>
                    </div>
                </div>
            </div>
        </div>
